...
import CardTwoTCU from "../molecules/CardTwoTCU";
import Search from "../molecules/Search";

function FlexCatalogTutorCU() {
    const data = [
        {
            id: 1,
            category: 'Java',
            ...
            <StyledFlexCatalog>
                {
                    articles.map(article => (
                        <CardTwoTCU key={article.id} img={article.image} subtitle={article.title} ruta="#" price={article.price} info={article.description} />
                    ))
                }
...
export default FlexCatalogTutorCU;